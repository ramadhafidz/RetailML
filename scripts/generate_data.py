...
df_jkt.to_csv(os.path.join(SAMPLE_DIR, "cabang_jakarta.csv"), index=False)
...
df_bgr.to_csv(os.path.join(SAMPLE_DIR, "cabang_bogor.csv"), index=False)
...
df_clg.to_csv(os.path.join(SAMPLE_DIR, "cabang_cilegon.csv"), index=False)
...
df_srg.to_csv(os.path.join(SAMPLE_DIR, "cabang_serang.csv"), index=False)
...
df_tgr.to_csv(os.path.join(SAMPLE_DIR, "cabang_tangerang.csv"), index=False)
